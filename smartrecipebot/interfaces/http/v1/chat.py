...
from smartrecipebot.application.services.runtime_provider import get_chat_runtime
from smartrecipebot.config import settings
from smartrecipebot.infrastructure.core.database import get_db
from smartrecipebot.infrastructure.persistence.crud import chat_message, chat_session
from smartrecipebot.interfaces.http.models.chat_message import ChatMessageCreate, ChatMessageResponse
from smartrecipebot.interfaces.http.models.chat_session import ChatSessionCreate, ChatSessionResponse
...
async def process_agent_query(message: str, session_id: str,
    ...
    try:
        ...
        result = await chat_runtime.invoke(query=message, config=config)
