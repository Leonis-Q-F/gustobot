...
from smartrecipebot.application.agents.kg_sub_graph.agentic_rag_agents.components.planner.models import PlannerOutput
from smartrecipebot.application.agents.kg_sub_graph.agentic_rag_agents.components.planner.prompts import create_planner_prompt_template
from smartrecipebot.application.agents.kg_sub_graph.agentic_rag_agents.components.state import InputState
            ...
            planner_output: PlannerOutput = await planner_chain.ainvoke(
                {
                    ...
                    "history_context": state.get("history_context", "（无历史上下文）"),
                }
            )
        else:
