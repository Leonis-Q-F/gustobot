...
from smartrecipebot.application.agents.kg_sub_graph.agentic_rag_agents.components.tool_selection.prompts import (
...
def create_tool_selection_node(
    ...
    async def tool_selection(
        ...
        history_context = context.get("history_context") or "（无历史上下文）"
