...
from smartrecipebot.infrastructure.persistence.db.models.chat_history import ConversationHistorySnapshot
from smartrecipebot.interfaces.http.models.chat_history import ConversationHistorySnapshotCreate
