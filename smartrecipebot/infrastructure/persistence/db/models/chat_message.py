...
from smartrecipebot.infrastructure.core.database import Base
...
class ChatSessionSnapshot(Base):
    """
    Session-level chat snapshot for quick restoration of conversation context.
    ...
    def __repr__(self) -> str:
        ...
        return f"<ChatSessionSnapshot id={self.id} query={query_preview!r}>"
