"""
SmartRecipe FastAPI application entry point.
"""
...
from smartrecipebot.application.services.lightrag_service import get_lightrag_service
from smartrecipebot.application.services.runtime_provider import initialize_runtime, shutdown_runtime
from smartrecipebot.config import settings
from smartrecipebot.infrastructure.core import configure_logging
from smartrecipebot.infrastructure.core.database import Base, engine
from smartrecipebot.interfaces.http import knowledge_router, lightrag_router
from smartrecipebot.interfaces.http.knowledge_router import get_neo4j_qa_service
from smartrecipebot.interfaces.http.v1 import api_router as api_v1_router
...
async def startup_event() -> None:
    ...
    import smartrecipebot.infrastructure.persistence.db.models  # noqa: F401 - Import all models to register them with Base
